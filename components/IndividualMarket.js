  ...
  return (
    <div>
      ...
      <div className={ open ? marketOpenCSS : marketClosedCSS }>
        ...
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">What will { asset === "0" ? "ETH" : asset === "1" ? "BTC" : "DOGE" }'s price be by { displayDate(expirationTime)}?</h5>
